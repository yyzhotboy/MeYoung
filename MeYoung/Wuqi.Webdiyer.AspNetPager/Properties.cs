...
namespace Wuqi.Webdiyer
{
    public partial class AspNetPager
    {
        ...
        ////////////////////添加代码///////////////////////////////////////////
        private static readonly object EventPageChangedComplate = new object();//liyansheng 2012-09-17 16:14:35
        ////////////////////////////////////////////////////////////////////////
        //bool pageChangeEventHandled = false; 
        //AspNetPager Version number, does not use reflection for perfomance reason
        const string VersionNumber = "8.0.0";
        ...
        public bool ShowPageSizeBox
        {
            get
            {
                if (null != cloneFrom) return cloneFrom.ShowPageSizeBox; 
                object obj = ViewState["ShowPageSizeBox"];
                //此处为当未设置ShowPageSizeBox属性时，取web.config中AppSettings的ShowPageSizeBox
                //if (obj == null)
                //{
                //    obj = 10;// System.Configuration.ConfigurationManager.AppSettings["ShowPageSizeBox"];
                //}
                return (obj == null) ? false : true;
                //return (obj == null) ? false : bool.Parse(obj.ToString());
            }
            set
            { ViewState["ShowPageSizeBox"] = value; }
        } 
