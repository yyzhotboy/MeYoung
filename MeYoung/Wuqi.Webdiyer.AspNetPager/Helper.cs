...
namespace Wuqi.Webdiyer
{
    public partial class AspNetPager
    {
        ...
        void listPageSize(HtmlTextWriter writer)
        {
            ...
            {
                writer.Write("<option value=\"");
                writer.Write(i); writer.Write("\"");
                if (i == PageSize) writer.Write(" selected=\"true\"");
                writer.Write(">");
                writer.Write(i);
                writer.Write("</option>");
            }
            ...
            //writer.Write("<option value=\"200\">200</option>");
            //writer.Write("<option value=\"500\">500</option>");
            //writer.Write("<option value=\"1000\">1000</option>");
        } 
