...
namespace Wuqi.Webdiyer
{
    public partial class AspNetPager
    {
        ...
        //liyansheng 2012-09-17 16:16:30 添加代码
        public event EventHandler PageChangedComplate
        {
            add
            {
                Events.AddHandler(EventPageChangedComplate, value);
            }
            remove
            {
                Events.RemoveHandler(EventPageChangedComplate, value);
            }
        }
    }
}
